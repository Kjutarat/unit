				...
				<nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm affix">
            		<ul class="nav bs-docs-sidenav">
						...
						<li class="">
						  ...
						  <ul class="nav">
						    <li class=""><a href="#whats-included-precompiled">Precompiled</a></li>
						    <li class=""><a href="#whats-included-source">Source code</a></li>
						  </ul>
						</li>
						<li class="">
						  <a href="#grunt">Compiling CSS and JavaScript</a>
						  <ul class="nav">
						    <li class=""><a href="#grunt-installing">Installing Grunt</a></li>
						    <li class=""><a href="#grunt-commands">Available Grunt commands</a></li>
						    <li class=""><a href="#grunt-troubleshooting">Troubleshooting</a></li>
						  </ul>
						</li>
						<li class="">
						...
						<li class="">
						  ...
						  <ul class="nav">
						    <li class=""><a href="#examples-framework">Using the framework</a></li>
						    <li class=""><a href="#examples-navbars">Navbars in action</a></li>
						    <li class=""><a href="#examples-custom">Custom components</a></li>
